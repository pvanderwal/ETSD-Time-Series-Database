...
#define etsdTimeS(seek) (etsdRW("r", (seek))?0:PBlock.longD[0])
#define readReg(reg) (PBlock.longD[BLOCKSIZE/4-(reg)])
#define readXData(addr) (PBlock.byteD[EtsdInfo.xDataStart+(addr)])
