/*************************************************************************
edsECM.h ETSD plugin used to receive and parse serial data from an Brultech ECM-1240
...
uint8_t edsCheckData(int16_t timeOut, uint8_t interV);
...
// returns data                             interV is ignored
